...
- Delete responses now also expose `matched.request` so selector input metadata has a structured canonical home, while top-level selector aliases remain for compatibility
