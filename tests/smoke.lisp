...
(defun %native-time-basic-parse-test ()
        (let ((timestamp (parse-iso-timestamp "20260329T102030Z")))
                (%check (and (listp timestamp) (eq :timestamp (first timestamp)))
                                                "native time parser accepts basic UTC timestamps")
                (%check (= 10 (getf (rest timestamp) :hour))
                                                "native time parser reads hours from basic UTC timestamps")
                (%check (= 0 (getf (rest timestamp) :offset-minutes))
                                                "native time parser normalizes basic UTC offsets correctly")))
  ...
  (%with-temporary-store-directory
   (lambda (directory)
     ...
     (let* ((dry-run-deleted (delete-registry-snapshot "snapshot-002" :directory directory :dry-run t))
            ...
            (dry-run-delete-request (%json-object-entry dry-run-delete-matched "request"))
            (dry-run-delete-summary (%json-object-entry dry-run-deleted "summary"))
            (dry-run-delete-summary-ids (%json-object-entry dry-run-delete-summary "affected-snapshot-ids"))
            (created-before-dry-run-delete-matched (%json-object-entry created-before-dry-run-deleted "matched"))
            (created-before-dry-run-delete-request (%json-object-entry created-before-dry-run-delete-matched "request"))
            (created-window-dry-run-delete-matched (%json-object-entry created-window-dry-run-deleted "matched"))
            (created-window-dry-run-delete-request (%json-object-entry created-window-dry-run-delete-matched "request"))
            (prefix-dry-run-delete-matched (%json-object-entry prefix-dry-run-deleted "matched"))
            (prefix-dry-run-delete-request (%json-object-entry prefix-dry-run-delete-matched "request"))
            (mixed-selector-dry-run-delete-matched (%json-object-entry mixed-selector-dry-run-deleted "matched"))
            (mixed-selector-dry-run-delete-request (%json-object-entry mixed-selector-dry-run-delete-matched "request"))
            (bulk-dry-run-delete-matched (%json-object-entry bulk-dry-run-deleted "matched"))
            (bulk-dry-run-delete-request (%json-object-entry bulk-dry-run-delete-matched "request"))
            (bulk-dry-run-delete-summary (%json-object-entry bulk-dry-run-deleted "summary"))
            (bulk-dry-run-delete-summary-ids (%json-object-entry bulk-dry-run-delete-summary "affected-snapshot-ids"))
            ...
            (delete-summary-ids (%json-object-entry delete-summary "affected-snapshot-ids"))
            (delete-audit (%json-object-entry deleted "audit"))
            (bulk-delete-summary (%json-object-entry bulk-deleted "summary"))
            (bulk-delete-summary-ids (%json-object-entry bulk-delete-summary "affected-snapshot-ids"))
            (bulk-delete-audit (%json-object-entry bulk-deleted "audit"))
            (dry-run-delete-snapshot-ids (%json-object-entry dry-run-deleted "snapshot-ids"))
            (dry-run-delete-paths (%json-object-entry dry-run-deleted "paths"))
       ...
       (%check (= 1 (%json-object-entry dry-run-delete-audit "explicit-count"))
               "native store delete audit mirrors explicit request selector count")
       (%check (and (= 1 (%json-object-entry dry-run-delete-audit "snapshot-count"))
                    (vectorp (%json-object-entry dry-run-delete-audit "snapshot-ids")))
               "native store single delete audit mirrors snapshot list metadata")
       ...
       (%check (and (= 1 (%json-object-entry dry-run-delete-request "explicit-count"))
                    (= 0 (%json-object-entry dry-run-delete-request "prefix-count"))
                    (eq :null (%json-object-entry dry-run-delete-request "created-before"))
                    (eq :null (%json-object-entry dry-run-delete-request "created-after")))
               "native store delete reports request selector metadata")
       ...
       (%check (and (= 1 (%json-object-entry dry-run-delete-summary "deleted-count"))
          ...
          (%check (and (= (%json-object-entry dry-run-deleted "before-count") (%json-object-entry dry-run-delete-summary "before-count"))
                                (= (%json-object-entry dry-run-deleted "after-count") (%json-object-entry dry-run-delete-summary "after-count"))
                                (= (%json-object-entry dry-run-deleted "would-after-count") (%json-object-entry dry-run-delete-summary "would-after-count"))
                                (= (%json-object-entry dry-run-deleted "deleted-count") (%json-object-entry dry-run-delete-summary "deleted-count")))
                        "native store delete dry-run compatibility counts mirror summary")
       (%check (and (vectorp (%json-object-entry dry-run-deleted "prefixes"))
                    (eq :null (%json-object-entry dry-run-deleted "created-before"))
                    (eq :null (%json-object-entry dry-run-deleted "created-after")))
               "native store single delete selector aliases mirror matched request")
          (%check (and (vectorp dry-run-delete-snapshot-ids)
                                (= 1 (length dry-run-delete-snapshot-ids))
                                (string= "snapshot-002" (aref dry-run-delete-snapshot-ids 0))
                                (vectorp dry-run-delete-paths)
                                (= 1 (length dry-run-delete-paths)))
                        "native store single delete exposes vector snapshot metadata like bulk delete")
          (%check (and (vectorp dry-run-delete-summary-ids)
                                (= 1 (length dry-run-delete-summary-ids))
                                (string= "snapshot-002" (aref dry-run-delete-summary-ids 0)))
                        "native store delete dry-run summary reports affected snapshot ids")
       ...
       (%check (string= "2026-03-31T00:00:00Z" (%json-object-entry created-before-dry-run-delete-request "created-before"))
               "native store created-before delete request mirrors the upper time bound")
       ...
       (%check (and (string= "2026-03-29T12:00:00Z" (%json-object-entry created-window-dry-run-delete-audit "created-after"))
                    (string= "2026-03-31T00:00:00Z" (%json-object-entry created-window-dry-run-delete-audit "created-before")))
               "native store created window delete audit mirrors request time bounds")
       (%check (and (string= "2026-03-29T12:00:00Z" (%json-object-entry created-window-dry-run-delete-request "created-after"))
                    (string= "2026-03-31T00:00:00Z" (%json-object-entry created-window-dry-run-delete-request "created-before")))
               "native store created window delete request mirrors both time bounds")
       ...
       (%check (= 1 (%json-object-entry prefix-dry-run-delete-audit "prefix-count"))
               "native store prefix delete audit mirrors request prefix count")
       (%check (and (= 1 (%json-object-entry prefix-dry-run-delete-request "prefix-count"))
                    (vectorp (%json-object-entry prefix-dry-run-delete-request "prefixes")))
               "native store prefix delete request mirrors prefix selectors")
       ...
       (%check (and (string= (%json-object-entry mixed-selector-dry-run-deleted "created-before")
                             (%json-object-entry mixed-selector-dry-run-delete-request "created-before"))
                    (string= (%json-object-entry mixed-selector-dry-run-deleted "created-after")
                             (%json-object-entry mixed-selector-dry-run-delete-request "created-after")))
               "native store delete selector aliases mirror matched request")
       ...
       (%check (= 2 (%json-object-entry bulk-dry-run-delete-audit "explicit-count"))
               "native store bulk delete audit mirrors explicit selector count")
       (%check (= 2 (%json-object-entry bulk-dry-run-delete-request "explicit-count"))
               "native store bulk delete request mirrors explicit selector count")
       ...
       (%check (= (%json-object-entry bulk-dry-run-deleted "deleted-count") (%json-object-entry bulk-dry-run-delete-summary "deleted-count"))
               "native store bulk delete compatibility deleted-count mirrors summary")
          (%check (and (vectorp bulk-dry-run-delete-summary-ids)
                                (= 2 (length bulk-dry-run-delete-summary-ids))
                                (string= "snapshot-001" (aref bulk-dry-run-delete-summary-ids 0))
                                (string= "snapshot-003" (aref bulk-dry-run-delete-summary-ids 1)))
                        "native store bulk delete dry-run summary reports affected snapshot ids")
       ...
       (%check (and (= 1 (%json-object-entry delete-summary "deleted-count"))
          ...
          (%check (and (vectorp delete-summary-ids)
                                (= 1 (length delete-summary-ids))
                                (string= "snapshot-002" (aref delete-summary-ids 0)))
                        "native store delete force summary reports affected snapshot ids")
       ...
       (%check (and (= 2 (%json-object-entry bulk-delete-summary "deleted-count"))
          ...
          (%check (and (vectorp bulk-delete-summary-ids)
                                (= 2 (length bulk-delete-summary-ids))
                                (string= "snapshot-001" (aref bulk-delete-summary-ids 0))
                                (string= "snapshot-003" (aref bulk-delete-summary-ids 1)))
                        "native store bulk delete force summary reports affected snapshot ids")
       ...
       (let* ((dry-run-pruned (prune-registry-snapshots 1 :directory directory :dry-run t))
              ...
              (after-prune (list-registry-snapshots :directory directory))
                      ...
                      (dry-run-prune-summary-ids (%json-object-entry dry-run-prune-summary "affected-snapshot-ids"))
                      (dry-run-prune-matched (%json-object-entry dry-run-pruned "matched"))
                      (dry-run-prune-request (%json-object-entry dry-run-prune-matched "request"))
                      (dry-run-kept-ids (%json-object-entry dry-run-pruned "kept-snapshot-ids"))
                      (prune-summary (%json-object-entry pruned "summary"))
                      (prune-summary-ids (%json-object-entry prune-summary "affected-snapshot-ids"))
                      (prune-matched (%json-object-entry pruned "matched"))
       ...
       (%check (and (vectorp (%json-object-entry dry-run-prune-audit "kept-snapshot-ids"))
                    (vectorp (%json-object-entry dry-run-prune-audit "deleted-snapshot-ids"))
                                                  (= (%json-object-entry dry-run-prune-audit "keep-count")
                                                          (%json-object-entry dry-run-prune-request "keep-count"))
                    (= 1 (%json-object-entry dry-run-prune-audit "kept-count"))
                    (= 2 (%json-object-entry dry-run-prune-audit "deleted-count")))
               "native store prune audit mirrors resolved keep and delete partitions")
       ...
       (%check (= 1 (%json-object-entry dry-run-prune-request "keep-count"))
               "native store prune reports request keep-count metadata")
       (%check (and (= 1 (%json-object-entry dry-run-prune-summary "keep-count"))
          ...
          (%check (and (= (%json-object-entry dry-run-pruned "before-count") (%json-object-entry dry-run-prune-summary "before-count"))
                                (= (%json-object-entry dry-run-pruned "after-count") (%json-object-entry dry-run-prune-summary "after-count"))
                                (= (%json-object-entry dry-run-pruned "would-after-count") (%json-object-entry dry-run-prune-summary "would-after-count"))
                                (= (%json-object-entry dry-run-pruned "keep-count") (%json-object-entry dry-run-prune-summary "keep-count"))
                                (= (%json-object-entry dry-run-pruned "kept-count") (%json-object-entry dry-run-prune-summary "kept-count"))
                                (= (%json-object-entry dry-run-pruned "deleted-count") (%json-object-entry dry-run-prune-summary "deleted-count")))
                        "native store prune compatibility counts mirror summary")
          (%check (and (vectorp dry-run-prune-summary-ids)
                                (= 2 (length dry-run-prune-summary-ids))
                                (string= "snapshot-002" (aref dry-run-prune-summary-ids 0))
                                (string= "snapshot-001" (aref dry-run-prune-summary-ids 1)))
                        "native store prune dry-run summary reports affected snapshot ids")
          (%check (and (vectorp (%json-object-entry dry-run-prune-matched "kept-snapshot-ids"))
                                (= 1 (%json-object-entry dry-run-prune-matched "kept-count"))
                                (= 2 (%json-object-entry dry-run-prune-matched "deleted-count")))
                        "native store prune dry-run reports matched keep and delete partitions")
       (%check (and (vectorp dry-run-kept-ids)
                    (= 1 (length dry-run-kept-ids))
                    (string= "snapshot-003" (aref dry-run-kept-ids 0))
                    (vectorp (%json-object-entry dry-run-prune-matched "kept-snapshot-ids"))
                    (string= (aref dry-run-kept-ids 0)
                             (aref (%json-object-entry dry-run-prune-matched "kept-snapshot-ids") 0)))
               "native store prune snapshot id aliases mirror matched partitions")
       ...
       (%check (and (vectorp (%json-object-entry prune-audit "kept-snapshot-ids"))
                    (vectorp (%json-object-entry prune-audit "deleted-snapshot-ids"))
                                                  (= (%json-object-entry prune-audit "keep-count")
                                                          (%json-object-entry (%json-object-entry prune-matched "request") "keep-count"))
                    (= 1 (%json-object-entry prune-audit "kept-count"))
                    (= 2 (%json-object-entry prune-audit "deleted-count")))
               "native store prune force audit mirrors resolved keep and delete partitions")
       ...
       (%check (and (= 1 (%json-object-entry prune-summary "keep-count"))
          ...
          (%check (and (vectorp prune-summary-ids)
                                (= 2 (length prune-summary-ids))
                                (string= "snapshot-002" (aref prune-summary-ids 0))
                                (string= "snapshot-001" (aref prune-summary-ids 1)))
                        "native store prune force summary reports affected snapshot ids")
          (%check (and (= 1 (%json-object-entry (%json-object-entry prune-matched "request") "keep-count"))
                                (= 1 (%json-object-entry prune-matched "kept-count"))
                                (= 2 (%json-object-entry prune-matched "deleted-count")))
                        "native store prune force preserves matched request and partition metadata")
          ...
          (emit-json
           (list :object
                 (cons "snapshot-id" "nightly")
                                                                 (cons "created-at" "2026-03-30T10:00:00Z")
                     (cons "adapter-count" (length nightly-adapters))
                     (cons "adapters" (coerce nightly-adapters 'vector))))
          stream)
           )
         (terpri stream))
                         (%rewrite-snapshot-created-at directory "baseline" "2026-03-29T10:00:00Z")
       (let* ((latest (latest-registry-snapshot-id :directory directory))
                (inventory (inventory-registry-snapshots :directory directory))
                (limited-inventory (inventory-registry-snapshots :directory directory :limit 1))
                (offset-inventory (inventory-registry-snapshots :directory directory :offset 1 :limit 1))
                (sorted-inventory (inventory-registry-snapshots :directory directory :sort "adapter-count-desc"))
                (oldest-first-inventory (inventory-registry-snapshots :directory directory :sort "created-at-asc"))
                                                                (adapter-count-filtered-inventory (inventory-registry-snapshots :directory directory :adapter-count-min 3))
                                                                (adapter-count-window-inventory (inventory-registry-snapshots :directory directory :adapter-count-min 2 :adapter-count-max 2))
                (prefix-filtered-inventory (inventory-registry-snapshots :directory directory :prefixes '("night")))
                (created-after-inventory (inventory-registry-snapshots :directory directory :created-after "2026-03-29T12:00:00Z"))
                                                                (combined-filtered-inventory (inventory-registry-snapshots :directory directory :prefixes '("base") :created-after "2026-03-29T12:00:00Z"))
                                                                (combined-stat-filtered-inventory (inventory-registry-snapshots :directory directory :prefixes '("base") :adapter-count-max 3))
              ...
              (inventory-page (%json-object-entry inventory "snapshot-page"))
              (inventory-snapshots (%json-object-entry inventory "snapshots"))
              (inventory-filters (%json-object-entry inventory "filters"))
              (inventory-summary (%json-object-entry inventory "summary"))
              (inventory-oldest-summary (%json-object-entry inventory-summary "oldest-snapshot"))
              (inventory-newest-summary (%json-object-entry inventory-summary "newest-snapshot"))
              (inventory-smallest-summary (%json-object-entry inventory-summary "smallest-snapshot"))
              (inventory-largest-summary (%json-object-entry inventory-summary "largest-snapshot"))
              (inventory-sort (%json-object-entry inventory "sort"))
              (limited-inventory-page (%json-object-entry limited-inventory "snapshot-page"))
              (limited-inventory-snapshots (%json-object-entry limited-inventory "snapshots"))
              (offset-inventory-page (%json-object-entry offset-inventory "snapshot-page"))
              (offset-inventory-snapshots (%json-object-entry offset-inventory "snapshots"))
              (sorted-inventory-snapshots (%json-object-entry sorted-inventory "snapshots"))
              (sorted-inventory-sort (%json-object-entry sorted-inventory "sort"))
              (oldest-first-snapshots (%json-object-entry oldest-first-inventory "snapshots"))
              (adapter-count-filtered-snapshots (%json-object-entry adapter-count-filtered-inventory "snapshots"))
              (adapter-count-filtered-summary (%json-object-entry adapter-count-filtered-inventory "summary"))
              (adapter-count-filtered-oldest (%json-object-entry adapter-count-filtered-summary "oldest-snapshot"))
              (adapter-count-filtered-newest (%json-object-entry adapter-count-filtered-summary "newest-snapshot"))
              (adapter-count-filtered-smallest (%json-object-entry adapter-count-filtered-summary "smallest-snapshot"))
              (adapter-count-filtered-largest (%json-object-entry adapter-count-filtered-summary "largest-snapshot"))
              (adapter-count-window-snapshots (%json-object-entry adapter-count-window-inventory "snapshots"))
              (prefix-filtered-snapshots (%json-object-entry prefix-filtered-inventory "snapshots"))
              (created-after-snapshots (%json-object-entry created-after-inventory "snapshots"))
              (combined-filtered-summary (%json-object-entry combined-filtered-inventory "summary"))
              (combined-filtered-snapshots (%json-object-entry combined-filtered-inventory "snapshots"))
              (combined-stat-filtered-snapshots (%json-object-entry combined-stat-filtered-inventory "snapshots"))
         ...
         (%check (and (vectorp inventory-snapshots)
                      (= 2 (length inventory-snapshots))
                      (string= "nightly" (%json-object-entry (aref inventory-snapshots 0) "snapshot-id"))
                      (string= "baseline" (%json-object-entry (aref inventory-snapshots 1) "snapshot-id")))
                 "native store inventory returns newest snapshots first")
         (%check (and (= 2 (%json-object-entry inventory-page "total-count"))
                      (= 2 (%json-object-entry inventory-page "returned-count"))
                      (= 0 (%json-object-entry inventory-page "remaining-count")))
                 "native store inventory includes pagination metadata")
            (%check (and (= 2 (%json-object-entry inventory-summary "matched-count"))
                      (= 2 (%json-object-entry inventory-summary "available-snapshot-count"))
                      (= 2 (%json-object-entry inventory-summary "selector-matched-count"))
                      (= 0 (%json-object-entry inventory-summary "adapter-count-filtered-out-count"))
                      (string= "baseline" (%json-object-entry inventory-summary "oldest-snapshot-id"))
                      (string= "baseline" (%json-object-entry inventory-oldest-summary "snapshot-id"))
                                  (string= "2026-03-29T10:00:00Z" (%json-object-entry inventory-summary "oldest-created-at"))
                      (string= "nightly" (%json-object-entry inventory-summary "newest-snapshot-id"))
                      (string= "nightly" (%json-object-entry inventory-newest-summary "snapshot-id"))
                                  (string= "2026-03-30T10:00:00Z" (%json-object-entry inventory-summary "newest-created-at"))
                      (string= "nightly" (%json-object-entry inventory-summary "smallest-snapshot-id"))
                      (string= "nightly" (%json-object-entry inventory-smallest-summary "snapshot-id"))
                      (= 6 (%json-object-entry inventory-summary "total-adapter-count"))
                      (= 2 (%json-object-entry inventory-summary "adapter-count-span"))
                      (= 4 (%json-object-entry inventory-oldest-summary "adapter-count"))
                      (= 2 (%json-object-entry inventory-newest-summary "adapter-count"))
                                  (= 2 (%json-object-entry inventory-summary "min-adapter-count"))
                      (string= "baseline" (%json-object-entry inventory-summary "largest-snapshot-id"))
                      (string= "baseline" (%json-object-entry inventory-largest-summary "snapshot-id"))
                                  (= 4 (%json-object-entry inventory-summary "max-adapter-count")))
                          "native store inventory summary reports matched-set boundaries")
            (%check (string= "created-at-desc" inventory-sort)
                    "native store inventory reports the applied sort mode")
            (%check (and (vectorp (%json-object-entry inventory-filters "prefixes"))
                                  (= 0 (%json-object-entry inventory-filters "prefix-count"))
                                  (eq :null (%json-object-entry inventory-filters "created-before"))
                                  (eq :null (%json-object-entry inventory-filters "created-after"))
                                  (eq :null (%json-object-entry inventory-filters "adapter-count-min"))
                                  (eq :null (%json-object-entry inventory-filters "adapter-count-max")))
                          "native store inventory echoes applied filters")
         (%check (and (vectorp limited-inventory-snapshots)
                      (= 1 (length limited-inventory-snapshots))
                      (= 1 (%json-object-entry limited-inventory-page "returned-count"))
                      (= 1 (%json-object-entry limited-inventory-page "remaining-count")))
                 "native store inventory can limit returned snapshots")
         (%check (and (vectorp offset-inventory-snapshots)
                      (= 1 (length offset-inventory-snapshots))
                      (string= "baseline" (%json-object-entry (aref offset-inventory-snapshots 0) "snapshot-id"))
                      (= 1 (%json-object-entry offset-inventory-page "offset")))
                 "native store inventory can offset snapshot rows")
         (%check (= 2 (%json-object-entry (aref inventory-snapshots 0) "adapter-count"))
                 "native store inventory reports per-snapshot adapter counts")
         (%check (and (string= "adapter-count-desc" sorted-inventory-sort)
                      (vectorp sorted-inventory-snapshots)
                      (= 2 (length sorted-inventory-snapshots))
                      (string= "baseline" (%json-object-entry (aref sorted-inventory-snapshots 0) "snapshot-id"))
                      (= 4 (%json-object-entry (aref sorted-inventory-snapshots 0) "adapter-count")))
                 "native store inventory can sort snapshots by adapter count")
         (%check (and (vectorp oldest-first-snapshots)
                      (= 2 (length oldest-first-snapshots))
                      (string= "baseline" (%json-object-entry (aref oldest-first-snapshots 0) "snapshot-id"))
                      (string= "nightly" (%json-object-entry (aref oldest-first-snapshots 1) "snapshot-id")))
                 "native store inventory can sort snapshots from oldest to newest")
            (%check (and (vectorp adapter-count-filtered-snapshots)
                                  (= 1 (length adapter-count-filtered-snapshots))
                                  (string= "baseline" (%json-object-entry (aref adapter-count-filtered-snapshots 0) "snapshot-id")))
                          "native store inventory can filter snapshots by minimum adapter count")
         (%check (and (= 1 (%json-object-entry adapter-count-filtered-summary "matched-count"))
                                  (= 2 (%json-object-entry adapter-count-filtered-summary "available-snapshot-count"))
                                  (= 2 (%json-object-entry adapter-count-filtered-summary "selector-matched-count"))
                                  (= 1 (%json-object-entry adapter-count-filtered-summary "adapter-count-filtered-out-count"))
                                  (string= "baseline" (%json-object-entry adapter-count-filtered-summary "oldest-snapshot-id"))
                                  (string= "baseline" (%json-object-entry adapter-count-filtered-summary "newest-snapshot-id"))
                                  (string= "baseline" (%json-object-entry adapter-count-filtered-oldest "snapshot-id"))
                                  (string= "baseline" (%json-object-entry adapter-count-filtered-newest "snapshot-id"))
                                                    (string= "baseline" (%json-object-entry adapter-count-filtered-summary "smallest-snapshot-id"))
                                                    (string= "baseline" (%json-object-entry adapter-count-filtered-summary "largest-snapshot-id"))
                                                    (string= "baseline" (%json-object-entry adapter-count-filtered-smallest "snapshot-id"))
                                                    (string= "baseline" (%json-object-entry adapter-count-filtered-largest "snapshot-id"))
                                  (= 4 (%json-object-entry adapter-count-filtered-summary "total-adapter-count"))
                                  (= 0 (%json-object-entry adapter-count-filtered-summary "adapter-count-span"))
                      (= 4 (%json-object-entry adapter-count-filtered-summary "min-adapter-count"))
                      (= 4 (%json-object-entry adapter-count-filtered-summary "max-adapter-count")))
                 "native store inventory summary reflects adapter-count filtering")
            (%check (and (vectorp adapter-count-window-snapshots)
                                  (= 1 (length adapter-count-window-snapshots))
                                  (string= "nightly" (%json-object-entry (aref adapter-count-window-snapshots 0) "snapshot-id"))
                                  (= 2 (%json-object-entry (aref adapter-count-window-snapshots 0) "adapter-count")))
                          "native store inventory can filter snapshots by adapter-count window")
            (%check (and (= 2 (%json-object-entry combined-filtered-summary "available-snapshot-count"))
                                  (= 0 (%json-object-entry combined-filtered-summary "selector-matched-count"))
                                  (= 0 (%json-object-entry combined-filtered-summary "matched-count")))
                          "native store inventory summary distinguishes selector-stage empty results")
         (%check (and (vectorp prefix-filtered-snapshots)
                      (= 1 (length prefix-filtered-snapshots))
                      (string= "nightly" (%json-object-entry (aref prefix-filtered-snapshots 0) "snapshot-id")))
                 "native store inventory can filter snapshots by prefix")
         (%check (and (vectorp created-after-snapshots)
                      (= 1 (length created-after-snapshots))
                      (string= "nightly" (%json-object-entry (aref created-after-snapshots 0) "snapshot-id")))
                 "native store inventory can filter snapshots by creation lower bound")
         (%check (= 0 (length combined-filtered-snapshots))
                 "native store inventory intersects prefix and time-window filters")
         (%check (= 0 (length combined-stat-filtered-snapshots))
                 "native store inventory intersects text and adapter-count filters")
...
(defun %cli-store-help-test ()
  (let ((output (%capture-output (lambda ()
    ...
    (%check (search "inventory-registry" output)
            "store help prints snapshot inventory queries")
    ...
    (%check (search "store inventory-registry [--prefix <text> ...] [--created-before <timestamp>] [--created-after <timestamp>] [--adapter-count-min <n>] [--adapter-count-max <n>] [--sort <created-at-desc|created-at-asc|snapshot-id-asc|snapshot-id-desc|adapter-count-asc|adapter-count-desc>]" output)
            "store help prints snapshot inventory filter and sort flags")
    ...
    (%check (search "store inventory-registry --limit 5" output)
            "store help demonstrates snapshot inventory queries")
    (%check (search "store inventory-registry --prefix nightly- --created-after 2026-03-29T12:00:00Z" output)
            "store help demonstrates filtered snapshot inventory queries")
    (%check (search "store inventory-registry --adapter-count-min 3 --sort adapter-count-desc" output)
            "store help demonstrates adapter-count snapshot inventory queries")
    (%check (search "store inventory-registry --sort adapter-count-desc --limit 5" output)
            "store help demonstrates sorted snapshot inventory queries")
